...
export const BM_TF_PowerOn = connect(stateToProps, dispatchToProps)(
class BM_TF_PowerOn extends React.Component {
  constructor (props) {
    super(props);
  ...
  render () {
    ...
    if (action === 'apply') {
      const msg = `Starting Tectonic console`;
...
BM_TF_PowerOn.canNavigateForward = ({cluster}) => {
